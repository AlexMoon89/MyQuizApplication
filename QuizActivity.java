...
public class QuizActivity extends AppCompatActivity {
    ...
    private final String KEY_QUESTION_COUNT = "keyQuestionCount";
    private final String KEY_MILLIS_LEFT = "keyMillisLeft";
    private final String KEY_ANSWERED = "keyAnswered";
    private final String KEY_QUESTION_LIST = "keyQuestionList";
